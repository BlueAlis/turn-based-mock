const TOKEN = "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ7XCJqd3RcIjpcIlwiLFwiYXV0aHNcIjpbXCJ1c2VyXCJdLFwid2F4QWRkcmVzc1wiOlwiYmx1ZWFsaXN6enp6XCJ9IiwiZXhwIjoxNjU1MTI1MjQ2LCJpYXQiOjE2NTUxMDcyNDZ9.HCQdu-IjSQxQVZjHD_L1UstPo7vKgpRjHL32jHBHR3yzA7Sfu8JhgSeeAnU9GQpwDQj8hdW6KljQPvDSKBsWFw"
const GAME_SCENE = {
	start: 'startScene',
	set: 'setGameScene',
	attack: 'attackScene',
...
//e27d783d-92f7-4b18-8183-ce015c75ef33
...
class Game {
  constructor() {
	...
	async onSetGame() {
		...
		try {
			await axios.post('http://localhost:8081/game/game', {
	...
	async onConnectSocket() {
		const response = await axios.post('http://localhost:8081/game/join-land-game/1', {}, {
    	headers: {Authorization: TOKEN}
    })
	...
	// Subscribe
	onSubscribe() {
		this.stompClient.subscribe(`/topic/game/${this.room}`, (greeting) => {
